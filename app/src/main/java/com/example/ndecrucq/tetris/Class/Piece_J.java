...
public class Piece_J extends Piece implements Movement, Possible_Movement {
    ...
    public Piece_J() {
        hauteur = 2;
        largeur = 3;
        matrice = new Matrix(new int[][]{{1, 1, 1}, {0, 0, 1}});
        pos_i = 0;
        pos_j = 5;
        color = Color.BLUE;
    }
    ...
    @Override
    public void rotate() {
        Matrix matrix_1 = new Matrix(new int[][]{{1, 1, 1}, {0, 0, 1}});
        Matrix matrix_2 = new Matrix(new int[][]{{0, 1}, {0, 1}, {1, 1}});
        Matrix matrix_3 = new Matrix(new int[][]{{1, 0, 0}, {1, 1, 1}});
        Matrix matrix_4 = new Matrix(new int[][]{{1, 1}, {1, 0}, {1, 0}});
